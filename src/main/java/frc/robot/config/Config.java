...
public final class Config {
    ...
    public static boolean INVERT_LEFT_MASTER = true;
    ...
    public static boolean INVERT_LEFT_ENCODER = true;
    ...
    public static double trackWidth = 0.61;
    ...
    public static double drivetrainWheelDiameter = 0.102; // 6 inches in meters
